...
- spring-vaadin-crud-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- spring-vaadin-crud-ui: main application module, development time
- spring-vaadin-crud-production: module that produces a production mode WAR for deployment
